...
if(temperatuur <=0){
  println("Äls het kouder is dan 0 graden, dan kan je schaatsen " + true);
}
...
if(mijnLengte<=1.60){
  println("Als je 1.60m of kleiner bent, mag je gratis naar her toilet bij de bezinepomp " + true);
}

int mijnMondGehouden = 15;
if(mijnMondGehouden>10){
println("Als je meer dan 10 seconden je mond kan houden, word ik gelukkig " + true);
}
